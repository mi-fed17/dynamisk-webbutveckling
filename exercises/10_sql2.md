...
* Du importerar filen **`products.sql`** som ligger uppe på zenit. Detta gör du genom att gå till din databas och välja **Import** sedan välja filen `products.sql`. När du är klar trycker du på **Go**.
